...
function signUp() {
    ...
    myMSALObj.loginPopup(signUpRequest)
        .then(handleResponse)
        .catch(error => {
            console.log(error);
        });
...
function signIn() {
    ...
    const signInRequest = b2cPolicies.authorities.signIn;

    myMSALObj.loginPopup(signInRequest)
        .then(handleResponse)
        .catch(error => {
            console.log(error);
        });
...
function signUpsignIn() {
    ...
    const signUpsignInRequest = b2cPolicies.authorities.signUpSignIn;
    
    myMSALObj.loginPopup(signUpsignInRequest)
        .then(handleResponse)
        .catch(error => {
            console.log(error);
        });
